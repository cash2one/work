...
namespace ZipUtils
{
	...
	// ------------------------------------------------------------------------------------------------------------------------
	DWORD ExtractZipToDir(LPCTSTR lpszZipFullName, LPCTSTR lpszUnZipPath );
	...
	//   压缩成功返回ZR_OK，压缩失败返回错误码。
	// ------------------------------------------------------------------------------------------------------------------------
	DWORD CompressFilesToZip(LPCTSTR lpszSrcDir,LPCTSTR lpszZipFullName, std::vector<CString> &vFileName);
