...
public:
	...
	int GetDataFromString(CStdString strData);   //通过字符串填充类的数据
        ...
        int GetVariableFromString(const int iNscode, const CStdString strNscode,const CStdString strData,T_NetstationVariableGroup *&NetVariable);
        ...
        int GetBaseInfoFromString(const CStdString strNscode,const CStdString strData,T_NetstationBaseInfo *&NetBase);
