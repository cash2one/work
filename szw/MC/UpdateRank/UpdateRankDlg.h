...
public:
	...
	*/	
	...
	@return 执行结果
	*/
	int GetPhone360Photo(IHTMLElementCollection *pTables, const KeyWordDataInfo &sData, CString &strFileName, BOOL &bResult);
	...
	*/	
	int GetILStylePhoto(IHTMLElementCollection *pLis, const KeyWordDataInfo &sData, CString &strFileName, BOOL &bResult);
...
/*
	...
	*/
	...
	@return 执行结果
	*/
	int GetWeixinPhoto(IHTMLElementCollection *pTables, const KeyWordDataInfo &sData, CString &strFileName, BOOL &bResult);
...
/*
	...
	*/
	...
	@return 是否包含在官网中
	*/
	static BOOL GetPageData(CStringA strRawData, CString &strContentType, CString &strRetData);
	...
	*/
	...
	@return TRUE表存在
	*/
	BOOL  FindIsOwnWebInWeixin(CString strHtml, const KeyWordDataInfo &sData);
	...
	*/
	...
	@return TRUE 包含在官网中
	*/
	static BOOL GetEmbedUrlData(CStringA& strData);
	...
	@return iResult 结果
	*/
	static int CheckWebFlag(const std::vector<CString>& vComp, const CString& strData,int iIndex);
	...
	@return 
	*/
	static int InspectEmbedWeb(CString &strData, const KeyWordDataInfo &sData, int &iResult);
	...
	@return True 查找成功；
	*/
	static int GetWebId(const CStringA &strWebList, DWORD &dwWebId,const CStringA &pChar);
