...
public:
	...
	void OpenLogFile(const TCHAR * pszTraceFileName, HWND hWnd = NULL, BOOL bNeedZip = FALSE);   //创建日志文件
	///////////////////////////////////

    //在构造函数中打开日志文件，并传入窗口句柄 
    CLogTrace(const TCHAR * pszTraceFileName, HWND hWnd,BOOL bNeedZip = FALSE);
...
private:
	...
	void CompressLogzip(const CString &strLogFileName); //压缩日志
private:
